...
/* eslint-disable */
// dom-to-image-more 3.4.0 embutido — evita dependência de CDN (cdnjs bloqueado por CSP no Vercel)
...
// herdar dados de outra cultura (ex.: soja pegando o "Previous week" do milho).
...
async function downloadCardPNG(elementId, filename) {
  ...
  // Inline todas as <img> como base64 para evitar cross-origin taint (logos)
